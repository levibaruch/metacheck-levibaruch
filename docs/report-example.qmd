...
- ✅️ [Power Analysis Check](#power-analysis-check){.green}: We detected 1 potential power analysis.  
...
### ✅️ Power Analysis Check {#power-analysis-check .green}

We detected 1 potential power analysis.

<details><summary>View detailed feedback</summary><div>

All essential information could be detected.
...
table <- structure(list(power_type = "sensitivity", statistical_test = "t-test", 
    sample_size = 50L, alpha_level = 0.05, power = 0.8, effect_size = 0.5, 
    effect_size_metric = "Cohen's d", software = "G*Power"), row.names = c(NA, 
...
NA), crossref_title_mismatch = c(FALSE, TRUE, FALSE, NA), crossref_author_mismatch = c(FALSE, 
FALSE, FALSE, NA), pubpeer_total_comments = c(NA, 3, NA, NA), 
    pubpeer_url = c(NA, "https://pubpeer.com/publications/3FA648ECECB88454C91804F09E2E56", 
    ...
    NA, NA, NA), retractionwatch = c(NA, "Retraction", NA, NA
