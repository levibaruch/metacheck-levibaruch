...
- [Funding Check](#funding-check){.red}: No funding statement was detected.  
- [COI Check](#coi-check){.red}: No conflict of interest statement was detected.  
- [Preregistration Check](#preregistration-check){.info}: We found 2 preregistrations.  
- [Power Analysis Check](#power-analysis-check){.red}: We detected 1 potential power analysis.  
...
# table data --------------------------------------
table <- structure(list("Code File Name" = c("Papercheck Test", NA, "Public", 
"bad.R", "bad.Rmd", "analysis.R", "Code/Study 1.r", "Codebook/Study 1 - csv - dataset 1.csv___CODEBOOK.csv", 
"Codebook/Study 1.csv___CODEBOOK.csv", "Data/Study 1 - csv - dataset 1.csv", 
"Data/Study 1.csv", "Materials/Study 1 - test txt file.txt", 
"Table of Contents Box #4377.csv"), Download = c("<a href='NA'>download</a>", 
"<a href='NA'>download</a>", "<a href='NA'>download</a>", "<a href='https://osf.io/download/6935bc117049c887a125cb25/'>download</a>", 
...
"<a href='NA'>download</a>", "<a href='NA'>download</a>", "<a href='NA'>download</a>", 
"<a href='NA'>download</a>", "<a href='NA'>download</a>", "<a href='NA'>download</a>", 
"<a href='NA'>download</a>")), row.names = c(NA, -13L), class = c("tbl_df", 
"tbl", "data.frame"))
...
table <- structure(list("Code File name" = "Code/Study 1.r", Language = "R", 
    "Files loaded in code but missing in repository" = "file.csv"), row.names = c(NA, 
-1L), class = c("tbl_df", "tbl", "data.frame"))
...
"6, 25", "1, 11")), row.names = c(NA, -3L), class = c("tbl_df", 
"tbl", "data.frame"))
